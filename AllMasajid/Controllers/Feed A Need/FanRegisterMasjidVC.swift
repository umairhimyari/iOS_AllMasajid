//
//  FanRegisterMasjidVC.swift
//  AllMasajid
//
//  Created by Fahad Shafiq on 16/02/2021.
...
class FanRegisterMasjidVC: UIViewController {
    ...
    @IBOutlet weak var yesFocalBTN: UIButton!
    @IBOutlet weak var noFocalBTN: UIButton!
    ...
    @IBAction func focalPersonSelected(_ sender: UIButton) {
        if sender.tag == 1 {
            //YES
            yesFocalBTN.setImage(#imageLiteral(resourceName: "radioChecked"), for: .normal)
            noFocalBTN.setImage(#imageLiteral(resourceName: "radioUnchecked"), for: .normal)
            isFocal = 1
        }else{
            //NO
            noFocalBTN.setImage(#imageLiteral(resourceName: "radioChecked"), for: .normal)
            yesFocalBTN.setImage(#imageLiteral(resourceName: "radioUnchecked"), for: .normal)
            isFocal = 0
        }
    }
...
extension FanRegisterMasjidVC: ThreeDotProtocol {
...
//        print(headers)
        APIRequestUtil.FanSendMasjidRegister(parameters: parameters, headers: httpHeaders, completion: APIRequestSubmitCompleted)
    }
