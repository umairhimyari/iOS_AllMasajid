...
@objc open class BAPrayerTimes: NSObject {
    ...
    private func prayerForBAPrayer(_ baPrayer: BAPrayer) -> Prayer {
        ...
        case BAPrayer.isha:
            return Prayer.isha
        case .ishraaq:
            return Prayer.ishraaq
        case .chaasht:
            return Prayer.chaasht
        case .awabeen:
            return Prayer.awabeen
        case .tahajjud:
    ...
    private func BAPrayerForPrayer(_ prayer: Prayer) -> BAPrayer {
        ...
        case .ishraaq:
            return BAPrayer.ishraaq
        case .chaasht:
            return BAPrayer.chaasht
        case .awabeen:
            return BAPrayer.awabeen
        case .tahajjud:
            return BAPrayer.tahajjud
        }
    }
}
